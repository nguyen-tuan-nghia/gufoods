    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">gufoods <sup></sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapspost" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ url('/dashboard/categoryPost/create') }}">Thêm danh mục bài viết</a>
                        <a class="collapse-item" href="{{ url('/dashboard/categoryPost/index') }}">Liệt kê danh mục bài viết</a>
                    </div>
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsemployee2"
                    aria-expanded="true" aria-controls="collapsemployee2">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Nhân viên</span>
                </a>
                <div id="collapsemployee2" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        @Has_role('thêm nhân viên')
                        <a class="collapse-item" href="{{ url('/dashboard/employee/create') }}">Thêm nhân viên</a>
                        @endHas_role
                        @Has_role('xem nhân viên')
                        <a class="collapse-item" href="{{ url('/dashboard/employee/index') }}">Liệt kê nhân viên</a>
                        @endHas_role
                    </div>
                </div>
            </li>
