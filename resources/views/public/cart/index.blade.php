  ...
  th, td {
                                    ...
                                    <div class="first-row">
                                        ...
                                        <div class="w3_agileits_card_number_grids">
                                            ...
                                            <div class="w3_agileits_card_number_grid_right">
                                                <div class="controls">
                                                    <select class="form-control" placeholder="Thành phố" id="delivery" name="delivery" required>
    ...
    <script>
        function delete_cart_item(id) {
            ...
            var qty=document.querySelector('#qty_in_cart'+id).innerHTML;
            $.ajax({
                ...
                success: function(data) {
                    giohang();
                    $("#cart_item").html(data);
                    var Cart_number =+ parseInt($(".count_item_pr").text())-parseInt(qty);
        ...
        function cart_minus_item(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    giohang();
                    $("#cart_item").html(data);
                    var Cart_number =+ parseInt($(".count_item_pr").text())-1;
                        $(".count_item_pr").text(Cart_number);
                }
            });
        }
